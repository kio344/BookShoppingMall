 ...
 * 
 * @author 5563a
 * 문수형 Pagination 기반으로 링크걸기 기능을 추가하였습니다.css는 재량껏 수정하시면 됩니다.
 * --------------------------------------------------------------------------------------
 ...
 * --------------------------------------------------------------------------------------
 * 타임리프 태그(\webapp\WEB-INF\view\layouts\commons\pagination_v2.html) 와 연동해 놓았으며 
 * 사용하실 페이지에 추가하시면 됩니다.
 * 
 * ex)
...
public class Pagination_v2 extends Pagination{
	 ...
	 * 링크 자동으로 걸어주기
	 * ex)
	 * 		link = "/shop/search?searchValue="+searchValue+"&searchType="+searchType+"&page="
	 */
	private String link;
